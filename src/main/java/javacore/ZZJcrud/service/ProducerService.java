...
import javacore.ZZJcrud.repository.ProducerRepository;
...
public class ProducerService {
    ...
    private static void delete() {
        System.out.println("Type the id of the producer the want to delete");
    ...
    private static void update(){
        ...
        Producer prooducerToUpdate = Producer.builder()
                .id(producerFromDb.getId())
                .name(name)
                .build();
        ProducerRepository.update(prooducerToUpdate);
    }
}
